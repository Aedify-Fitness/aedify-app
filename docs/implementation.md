...
| Field                 | Value                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
| --------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Current Milestone** | M4 — Persistence Foundation (Programmes, Saved Workouts, Workout Sessions)                                                                                                                                                                                                                                                                                                                                                                                                   |
| **Status**            | V1-M3-001 through V1-M3-009 complete — all M3 tickets closed. **V1-M4-001 implementation complete, tests passing** — schema v8 (15 tables, 15 DAOs, 11 domain models, 3 repositories, provider wiring, privacy updates, expanded rows data integrity fix, root DAO upsert mode fix). 6 repository tests added (CRUD, expanded rows round-trip, child replacement, archive, soft-delete, activate/deactivate). `flutter analyze` — 0 issues. `flutter test` — 612/612 passed. |
| **Blockers**          | None                                                                                                                                                                                                                                                                                                                                                                                                                                                                         |

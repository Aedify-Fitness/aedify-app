...
void main() {
  ...
  test(
    ...
    () async {
      ...
      expect(options[0].providerName, equals(AiProviderName.openai));
      expect(options[1].providerName, equals(AiProviderName.anthropic));
      expect(options[2].providerName, equals(AiProviderName.google));
  ...
  test('correct OpenAI models', () async {
    ...
    final openAi = options.firstWhere(
      (o) => o.providerName == AiProviderName.openai,
    );
  ...
  test('correct Anthropic model display names', () async {
    ...
    final anthropic = options.firstWhere(
      (o) => o.providerName == AiProviderName.anthropic,
    );
  ...
  test('correct Google models', () async {
    final options = await repository.getProviderOptions();
    final google = options.firstWhere(
      (o) => o.providerName == AiProviderName.google,
    );
